...
#TODO 11    GitHub.
#TODO 12    Нормально переименовать процедуры
...
#TODO 25    Бланки разместить на ощем ресурсе и в ответе указать, что можно их взять на ресурсе.
